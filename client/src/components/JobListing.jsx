    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 pb-8">
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        <button
          ...
          className="px-6 py-1.5 rounded border border-gray-400 lg:hidden cursor-pointer active:scale-95 transition"
        >
        ...
        {/* Location Filter */}
        <div className={showFilter ? "" : "max-lg:hidden"}>
          <h4 className="font-medium text-lg py-4 pt-5">Search by Location</h4>
          <ul className="space-y-2">
      ...
      <section className="w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        ...
        {filteredJobs.length > 0 && (
          <div className="flex items-center justify-center space-x-2 mt-10 mb-10">
            <a href="#job-list">
              <img
