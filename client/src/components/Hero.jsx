    ...
    <div className="container 2xl:px-20 mx-auto my-10">
      <div className="bg-linear-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl">
        ...
        <div className="flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto">
          ...
          <button
            onClick={onSearch}
            className="bg-blue-600 px-6 py-2 rounded text-white m-1 cursor-pointer active:scale-95 transition"
          >
            Search
          </button>
        </div>
      ...
      {/* <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
            <div className='flex lg:gap-16 justify-center gap-10 flex-wrap'>
